...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210906_scsw_8b0aa67b3f9244b89809_20210907092820_archive.zip';
	const ARCHIVE_SIZE		 = '255365133';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8b0aa67-07092820';
    const SECONDARY_PACKAGE_HASH = '9da90ca-07092820';
	const VERSION			 = '1.4.2';
